...
export type ModelMode = 'default' | 'adaptiveUsage' | 'sonnet' | 'opus' | 'gpt-5-minimal' | 'gpt-5-low' | 'gpt-5-medium' | 'gpt-5-high' | 'gpt-5-codex-low' | 'gpt-5-codex-medium' | 'gpt-5-codex-high' | 'gemini-2.0-flash-exp' | 'gemini-2.0-flash-thinking-exp' | 'gemini-1.5-pro' | 'gemini-1.5-flash' | 'cursor-default';
