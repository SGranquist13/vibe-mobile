/**
 * Chinese (Simplified) translations for the Vibe on the Go app
 * Values can be:
...
export const zhHans: TranslationStructure = {
    ...
    settings: {
        ...
        about: '关于',
        aboutFooter: 'Vibe on the Go 是一个 Codex 和 Claude Code 移动客户端。它采用端到端加密，您的账户仅存储在本地设备上。与 Anthropic 无关联。',
        whatsNew: '更新日志',
    ...
    newSession: {
        ...
        title: '启动新会话',
        noMachinesFound: '未找到设备。请先在您的计算机上启动 Vibe 会话。',
    ...
    server: {
        ...
        notValidVibeServer: '不是有效的 vibe-on-the-go 服务器',
        changeServer: '更改服务器',
    ...
    sessionInfo: {
        ...
        vibeSessionIdCopied: 'vibe-on-the-go 会话 ID 已复制到剪贴板',
        failedToCopySessionId: '复制 Vibe 会话 ID 失败',
        vibeSessionId: 'vibe-on-the-go 会话 ID',
        ...
        updateCliInstructions: '请运行 npm install -g vibe-cli@latest',
        deleteSession: '删除会话',
    ...
    agentInput: {
        ...
        codexModel: {
            ...
            gpt5Medium: 'GPT-5 中',
            gpt5High: 'GPT-5 高',
            compactGpt5CodexLow: 'Codex 低',
            compactGpt5CodexMedium: 'Codex 中',
            compactGpt5CodexHigh: 'Codex 高',
            compactGpt5Minimal: '5 极简',
            compactGpt5Low: '5 低',
            compactGpt5Medium: '5 中',
            compactGpt5High: '5 高',
            compactDefault: '默认',
        },
        geminiModel: {
            title: 'GEMINI 模型',
            gemini20FlashExp: 'Gemini 2.0 Flash (实验性)',
            gemini20FlashThinkingExp: 'Gemini 2.0 Flash Thinking (实验性)',
    ...
    terminal: {
        ...
        terminalRequestDescription: '有终端正在请求连接到您的 Vibe on the Go 账户。这将允许终端安全地发送和接收消息。',
    ...
    machine: {
        ...
        offlineHelp: '• 确保您的计算机在线\n• 运行 `vibe daemon status` 进行诊断\n• 您是否在运行最新的 CLI 版本？请使用 `npm install -g vibe-cli@latest` 升级',
        daemon: '守护进程',
        status: '状态',
        stopDaemon: '停止守护进程',
