...
export default function ClaudeOAuth() {
    ...
    return (
        <>
            <OAuthViewUnsupported name="Claude" command="vibe connect claude" />
            {/* <OAuthView
                name="Claude"
                command="vibe connect claude"
...
const OAuthViewUnsupported = React.memo((props: {
    ...
    const command = props.command || `vibe connect ${props.name.toLowerCase()}`;
